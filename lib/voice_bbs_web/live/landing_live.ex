  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-gradient-to-b from-white via-purple-50/30 to-white flex flex-col items-center px-6 overflow-hidden">
      ...
      <div :if={@step == 2} class="flex-1 flex flex-col items-center justify-center">
        ...
        <button :if={@mic_ok != nil} phx-click="next-step"
                class="mt-6 px-6 py-3 bg-purple-500 text-white rounded-full text-sm font-medium hover:bg-purple-600 transition shadow-lg">
          次
        </button>
      </div>
